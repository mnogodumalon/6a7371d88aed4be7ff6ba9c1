...
const T = {
  title: 'Public pages',
  subtitle: 'Forms and pages you can share via link — no account required for visitors.',
  empty: 'No pages yet. Ask in the chat for the public page you need — it gets built and shows up here.',
  origin_auto: 'Suggested',
  origin_user: 'Yours',
  origin_agent: 'AI page',
  ...
  copy: 'Copy link',
  copied: 'Copied!',
  confirm_title: 'Publish this page?',
  can_do: 'Anyone with the link can:',
  cannot_do: 'Nobody can:',
  can_submit: 'submit entries',
  can_view: 'see this data',
  cannot_line: 'see or change existing data.',
  cancel: 'Cancel',
  confirm_publish: 'Publish',
  fields: 'Fields',
  fields_title: 'Choose fields',
  fields_intro: 'Choose which fields appear in the public form.',
  field_required: 'Required — always included',
  field_file: 'File upload is not supported publicly',
  field_exposes: 'Reveals the list of linked entries to visitors',
  save: 'Save',
};
