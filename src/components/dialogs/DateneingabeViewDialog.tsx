...
interface DateneingabeViewDialogProps {
  open: boolean;
  onClose: () => void;
  record: Dateneingabe | null;
  onEdit: (record: Dateneingabe) => void;
}

export function DateneingabeViewDialog({ open, onClose, record, onEdit }: DateneingabeViewDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>View Dateneingabe</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="pt-2 border-t border-border">
            <AttachmentsSection appId={APP_IDS.DATENEINGABE} recordId={record.record_id} readOnly />
          </div>
        </div>
      </DialogContent>
    </Dialog>
