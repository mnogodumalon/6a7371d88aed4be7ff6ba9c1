            ...
            <div className="flex flex-col items-center justify-center gap-2 text-center px-3">
              {uploading ? (
                ...
                <>
                  ...
                  <p className="text-sm font-medium">Drop file here or click</p>
    ...
    return (
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Save the record first, then attachments can be added.
        </p>
      </div>
    );
  }
    ...
    >
              ...
              <li key={att.id}>
                <Wrapper {...wrapperProps}>
                  ...
                  <div className="flex-1 min-w-0">
                    {att.type === 'file' && att.value && (
                      <>
                        <p className="text-sm font-medium truncate">{att.label ?? 'File'}</p>
      ...
      {!readOnly && (
        <ConfirmDialog
          ...
          description={deleteTarget?.label ? `«${deleteTarget.label}»` : 'This attachment will be permanently removed.'}
        />
      )}
    </div>
  );
