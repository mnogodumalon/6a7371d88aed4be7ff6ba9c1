...
const APP_TITLE = 'Meine Erfassung';
const APP_ID = '6a7371ca5fe330a92b755843';
    ...
    <div className="contents">
      ...
      {!IS_EMBED && (
        <la-drawer ref={drawerRef}>
          ...
          <la-nav-section type="secondary" label="View">
            ...
            <la-nav-section type="primary" label="Data management" icon="IconMenu2" dense="">
          ...
          <la-nav-section type="secondary" label="Actions">
            <IntentsNav />
            <ActionsSidebar />
            <PublicPagesNav />
            <div className="pt-2">
          ...
          <div slot="footer" className="flex flex-wrap gap-x-4 gap-y-1 border-t border-sidebar-border py-3 text-sm font-medium text-muted-foreground">
            <a href="/impressum.htm" className="hover:text-foreground transition-colors">Imprint</a>
            <a href="/datenschutz.htm" className="hover:text-foreground transition-colors">Privacy</a>
